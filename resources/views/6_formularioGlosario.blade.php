...
<div class="w3-container w3-margin-left" style="margin-top:20px">
    ...
    <h2 style="margin-top:40px"><b style="color:teal;">Ingresar el código de caso:</b> Es un texto que representa el código del caso al cual se quiere generar una propuesta.</h2>
    <h2 style="margin-top:40px"><b style="color:teal;">Tipo de Cáncer:</b> Es una lista de opciones del tipo de cáncer, que tiene el paciente.</h2>
    ...
    <h2 style="margin-top:40px"><b style="color:teal;"> Nivel del cáncer:</b> Es una lista del estado de manera particular para cada tipo de cáncer, en el que está el paciente. Este valor describe, cuanto cáncer hay en el cuerpo de una persona y cuánto se ha propagado.</h2>
    <h3><ul class="w3-container" style="margin-left:50px">
    ...
    <h2 style="margin-top:40px"><b style="color:teal;"> Descripción del Caso:</b> Es una breve descripción de las características relevantes para el caso, como enfermedades preexistentes y tratamientos previos, entre otros.</h2>
    <h2 style="margin-top:40px"><b style="color:teal;"> Sexo del Paciente:</b> Es una lista con el sexo del paciente, haciendo referencia a las características biológicas y fisiológicas. Es un sector del formulario que se puede evitar ingresar, siempre que no sea relevante esta información para el caso.</h2>
    <h3><ul class="w3-container" style="margin-left:50px">
    ...
    <h2 style="margin-top:40px"><b style="color:teal;"> Rango de Edad del Paciente:</b> Es una lista con el rango de edad del paciente.</h2>
    <h3><ul class="w3-container" style="margin-left:50px">
    ...
    <h2 style="margin-top:40px"><b style="color:teal;"> Condición de Radioterapia:</b> Es una lista donde se selecciona la condición de tratamiento de radioterapia.</h2>
    <h3><ul class="w3-container" style="margin-left:50px">
    ...
    <h2 style="margin-top:40px"><b style="color:teal;"> Técnica de Tratamiento:</b> Es una lista con las técnicas de tratamiento.</h2>
    <h3><ul class="w3-container" style="margin-left:50px">
    ...
    <h2 style="margin-top:40px"><b style="color:teal;"> Tipo de Optimización:</b> Se despliega por medio de una lista el tipo de optimización.</h2>
    <h3><ul class="w3-container" style="margin-left:50px">
    ...
    <h2 style="margin-top:40px"><b style="color:teal;"> Número total de beamlets:</b> Se ingresa un número entero, que corresponde al número total de Beamlets utilizados en el Caso. El Blemet, es un pequeño elemento de intensidad de fotones que subdivide un haz, para optimizar la distribución de la intensidad o calcular la dosis.</h2>
    <h2 style="margin-top:40px"><b style="color:teal;"> Tamaño del beamlets:</b> Es el número del tamaño de la grilla del beamlet.</h2>
    <h2 style="margin-top:40px"><b style="color:teal;"> Coplanar:</b> Se indica 'Si', si el modelo a utilizar es coplanario (la radiación se administra por un solo plano), o 'No' si el modelo a utilizar no es coplanario (la radiación se administra por múltiples planos).</h2>
    <h2 style="margin-top:40px"><b style="color:teal;"> Número de Ángulos:</b> Se ingresa un número, que representa el número de ángulos utilizados en el procedimiento.</h2>
    <h2 style="margin-top:40px"><b style="color:teal;"> Órgano a irradiar:</b> Es una lista con el nombre del órgano o elemento a irradiar. </h2>
    <h3><ul class="w3-container" style="margin-left:50px">
    ...
    <h2 style="margin-top:40px"><b style="color:teal;"> El órgano contiene el tumor:</b> Se identifica con la selección de 'Si' o 'No', si el órgano referenciado contiene un tumor.</h2>
    <h2 style="margin-top:40px"><b style="color:teal;"> Nivel de prioridad del Órgano:</b> Se ingresa un número entero con el nivel de prioridad del órgano, siendo el más alto en nivel 1 donde se va a enfocar en preservar ese órgano.</h2>
    <h2 style="margin-top:40px"><b style="color:teal;"> Volumen total del objetivo:</b> Se ingresa el valor numérico con volumen total objetivo del órgano, con la unidad referenciada.</h2>
    <h2 style="margin-top:40px"><b style="color:teal;"> Número de vóxeles objetivo:</b> Se ingresa el valor numérico de la cantidad de voxels objetivo del órgano. El voxel es la unidad cúbica que compone un objeto tridimensional, usada con el fin de discretizar la zona.</h2>
    <h2 style="margin-top:40px"><b style="color:teal;"> Indicadores:</b> Los indicadores corresponden a términos, que se pueden usar como, comparadores entre tratamientos de radioterapia.</h2>
    ...
    <h2 style="margin-top:40px"><b style="color:teal;"> Archivo Médico comprimido:</b> Consta de Subir archivos comprimido en formato zip o rar, relacionado al caso.</h2>
    <h2 style="margin-top:40px"><b style="color:teal;"> País de Planificación:</b> Es en donde se selecciona el país de planificación.</h2>
    <h3><ul class="w3-container" style="margin-left:50px">
        <li> Afganistán</li>
        <li> Albania</li>
        <li> Alemania</li>
    ...
    <h2 style="margin-top:40px"><b style="color:teal;"> Nombre de la Institución</b> Se escribe el nombre de la institución a la cual representa el autor.</h2> 
    <h3><ul class="w3-container" style="margin-left:50px">
    ...
    <h2 style="margin-top:40px"><b style="color:teal;"> Nombre del Autor:</b> Se ingresa el nombre del autor o encargado, que está levantando la información.</h2>
    <h2 style="margin-top:40px"><b style="color:teal;"> Email de Contacto:</b> Se escribe el contacto del email relacionado con el autor.</h2>
    <h2 style="margin-top:60px"><b> Bibliografía:</b></h2>
